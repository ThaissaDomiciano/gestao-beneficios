        ...
        <Card className="w-full h-full border-none rounded-none md:rounded-tl-[40%] bg-[var(--background)] shadow overflow-hidden flex">
          <div className="m-auto w-full max-w-sm">
            <CardHeader className="space-y-2 p-0">
              <p className="flex items-center gap-2 text-[var(--verde-800)] font-bold text-xl">
                <Image src="/logoWeb.svg" alt="Logo" width={60} height={60} />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-[var(--verde-800)] text-[var(--branco)]"
                disabled={loading}
              >
...
// 🔹 Página exportada, envolvendo o componente em Suspense
